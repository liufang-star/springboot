...
//                user.setAdcode(usersExcelVo.getAdcode());
//                user.setDomicile(usersExcelVo.getDomicile());
//                user.setDocumenttype(usersExcelVo.getDocumenttype());
//                user.setDocumentphone(usersExcelVo.getDocumentphone());
//                user.setPhone(usersExcelVo.getPhone());
//                user.setAddress(usersExcelVo.getAddress());
//                user.setHousehold(usersExcelVo.getHousehold());
//                user.setRelation(usersExcelVo.getRelation());
