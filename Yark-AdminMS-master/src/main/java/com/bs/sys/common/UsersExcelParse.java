...
//                    usersExcelVo.setAdcode((ExcelUtil.formatCell(row.getCell(0))));
//                    usersExcelVo.setName(ExcelUtil.formatCell(row.getCell(1)));
//                    usersExcelVo.setDomicile(ExcelUtil.formatCell(row.getCell(2)));
                    usersExcelVo.setLoginname(ExcelUtil.formatCell(row.getCell(1)).split("\\.")[0]);
//                    usersExcelVo.setDocumenttype(ExcelUtil.formatCell(row.getCell(4)));
//                    usersExcelVo.setDocumentphone(ExcelUtil.formatCell(row.getCell(5)));
//                    usersExcelVo.setPhone(ExcelUtil.formatCell(row.getCell(6)));
//                    usersExcelVo.setAddress(ExcelUtil.formatCell(row.getCell(7)));
//                    usersExcelVo.setHousehold(ExcelUtil.formatCell(row.getCell(8)));
//                    usersExcelVo.setRelation(ExcelUtil.formatCell(row.getCell(9)));
//                    usersExcelVo.setRemark(ExcelUtil.formatCell(row.getCell(10)));
